...
const LINKS = [
  ...
  { label: "Intelligence", href: "#knowledge-graph", emphasize: true },
      ...
      >
        ...
        <div className="flex items-center gap-3">
          <div className="hidden items-center gap-8 rounded-xl bg-white/[0.04] px-7 py-3 md:flex">
            {LINKS.map((l) => (
              <a
                ...
                href={l.href}
                data-cursor="hover"
                className={`text-sm transition-colors duration-300 hover:text-neon ${
                  l.emphasize ? "font-semibold text-white" : "text-white/85"
                }`}
              >
                {l.label}
              </a>
          ...
          <a
            href="#cta"
            data-cursor="hover"
            className="electric-gradient group flex items-center gap-3 rounded-xl py-1.5 pl-1.5 pr-5 shadow-[0_0_28px_rgba(61,123,255,0.3)] transition-all duration-300 hover:scale-[1.03] hover:shadow-[0_0_40px_rgba(61,123,255,0.45)]"
          >
